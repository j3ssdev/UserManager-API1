...
//Dia 30: /api/users (Conectado a Prisma a través de userRouter) FALTABA ESTO
...
// // COMENTADO, NO ES NECESARIO, YA QUE SE MUESTRA EN EL ROUTER DE USUARIOS
// //Dia 4: GET Users
...
app.post("/api/debug/request", (req, res) => {
  ...
  //Dia30 Montaje de rutas para usuarios
  app.use("/api/users", userRouter);
});
